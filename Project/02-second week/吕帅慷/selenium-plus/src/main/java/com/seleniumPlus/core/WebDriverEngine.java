...
public class WebDriverEngine {
     ...
     * @return 元素的参数值
     */
    public String getAttribute(String locator, String arg) {
        return finder.findElement(locator).getAttribute(arg);
    }
     ...
     *
     * @param locator 元素定位
     * @param cssValue css属性
     * @return css的属性值
     */
    public String getCss(String locator, String cssValue) {
        return finder.findElement(locator).getCssValue(cssValue);
    }
